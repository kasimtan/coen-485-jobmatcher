...
import com.jobmatcher.domain.CoverLetterIntegrationTest;
...
privileged aspect CoverLetterIntegrationTest_Roo_IntegrationTest {
    
    declare @type: CoverLetterIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: CoverLetterIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext*.xml");
    
    @Autowired
    CoverLetterDataOnDemand CoverLetterIntegrationTest.dod;
    
    @Autowired
    CoverLetterService CoverLetterIntegrationTest.coverLetterService;
    
    @Test
    public void CoverLetterIntegrationTest.testCountAllCoverLetters() {
    ...
    @Test
    public void CoverLetterIntegrationTest.testFindCoverLetter() {
    ...
    @Test
    public void CoverLetterIntegrationTest.testFindAllCoverLetters() {
        Assert.assertNotNull("Data on demand for 'CoverLetter' failed to initialize correctly", dod.getRandomCoverLetter());
        long count = coverLetterService.countAllCoverLetters();
    ...
    @Test
    public void CoverLetterIntegrationTest.testFindCoverLetterEntries() {
        Assert.assertNotNull("Data on demand for 'CoverLetter' failed to initialize correctly", dod.getRandomCoverLetter());
        long count = coverLetterService.countAllCoverLetters();
    ...
    @Test
    public void CoverLetterIntegrationTest.testSaveCoverLetter() {
        Assert.assertNotNull("Data on demand for 'CoverLetter' failed to initialize correctly", dod.getRandomCoverLetter());
    ...
    @Test
    public void CoverLetterIntegrationTest.testDeleteCoverLetter() {
        CoverLetter obj = dod.getRandomCoverLetter();
        Assert.assertNotNull("Data on demand for 'CoverLetter' failed to initialize correctly", obj);
        BigInteger id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CoverLetter' failed to provide an identifier", id);
